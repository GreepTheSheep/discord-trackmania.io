...
CREATE TABLE IF NOT EXISTS `totd_channels` ( `guildId` VARCHAR(64) NOT NULL , `userId` VARCHAR(64) NOT NULL , `channelId` VARCHAR(64) NOT NULL , `roleId` VARCHAR(64) NULL , `threads` tinyint(1) NOT NULL DEFAULT 0, PRIMARY KEY (`guildId`), UNIQUE (`channelId`));
