...
function buildEmbedMessage(player){
    ...
    if (player.meta && (player.meta.twitch || player.meta.youtube || player.meta.twitter)) embed.addField('Links:', `${player.meta.twitch ? `- [Twitch](https://twitch.tv/${player.meta.twitch})\n`:""}${player.meta.youtube ? `- [YouTube](https://youtube.com/channel/${player.meta.youtube})\n`:""}${player.meta.twitter ? `- [Twitter](https://twitter.com/${player.meta.twitter})\n`:""}`, true)
